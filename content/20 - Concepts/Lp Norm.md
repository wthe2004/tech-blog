---
{"publish":true,"created":"2025-09-24T13:59:24.934-04:00","modified":"2025-09-26T09:36:21.840-04:00","tags":["ai","math"],"cssclasses":""}
---
...
**应用**：L2范数在科学和工程中无处不在。在机器学习中，它被用于[[20 - Concepts/L2正则化]]（又称权重衰减），通过惩罚数值较大的模型参数来防止过拟合。它也是衡量误差（如均方根误差）的基础。
...
| **[[20 - Concepts/L2范数]]** | $\sqrt{\sum_{i=1}^{n} x_i^2}$ | 欧几里得距离、向量的模 | [[20 - Concepts/L2正则化]]、[[20 - Concepts/最小二乘法]]、距离计算 |
